  ...
  var i = function (t) {
    ...
    o = new Array(24)
      ...
      .map(function (t, e) {
        var s = i(e);
        return (
          '<li class="cell-2 js-hour-cell" data-val="' + s + '">' + s + "</li>"
        );
      })
      .join(""),
    c = new Array(12)
        ...
        return (
          ...
          this.off("click").on("click", function (i) {
            ...
            e.test(n)
              ...
              : ((n = new Date()), (s = n.getHours()), (o = n.getMinutes()));
