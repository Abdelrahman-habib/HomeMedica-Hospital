...
(function (f) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (h, x) {
        h || (h = window);
        return f(x, h, h.document);
      })
    ...
    v = function (a, b) {
      "undefined" === typeof l &&
        (l = h.moment
          ...
          ? h.luxon
          : null);
      this.c = f.extend(!0, {}, v.defaults, b);
      b = this.c.classPrefix;
      var c = this.c.i18n;
      if (!l && "YYYY-MM-DD" !== this.c.format)
  ...
  f.extend(v.prototype, {
    ...
    _constructor: function () {
      var a = this,
        ...
        g = function () {
          var d = a.dom.input.val();
          d !== c && (a.c.onChange.call(a, d, a.s.d, a.dom.input), (c = d));
        };
      ...
      this._optionsTitle();
      f(x).on("i18n.dt", function (d, e) {
        e.oLanguage.datetime &&
          (f.extend(!0, a.c.i18n, e.oLanguage.datetime), this._optionsTitle());
      });
      ...
      this.dom.container
        .on("change", "select", function () {
          var d = f(this),
            e = d.val();
          d.hasClass(b + "-month")
            ? (a._correctMonth(a.s.display, e), a._setTitle(), a._setCalander())
            : d.hasClass(b + "-year")
            ? (a.s.display.setUTCFullYear(e), a._setTitle(), a._setCalander())
            : d.hasClass(b + "-hours") || d.hasClass(b + "-ampm")
            ? (a.s.parts.hours12
                ? ((d =
                    1 *
                    f(a.dom.container)
                  ...
                  (e =
                    ...
                    f(a.dom.container)
                      ...
                      .val()),
                  a.s.d.setUTCHours(
                    12 !== d || e ? (e && 12 !== d ? d + 12 : d) : 0
                  ))
                : a.s.d.setUTCHours(e),
              a._setTime(),
              a._writeOutput(!0),
              g())
            : d.hasClass(b + "-minutes")
            ? (a.s.d.setUTCMinutes(e), a._setTime(), a._writeOutput(!0), g())
            : d.hasClass(b + "-seconds") &&
              (a.s.d.setSeconds(e), a._setTime(), a._writeOutput(!0), g());
          a.dom.input.focus();
          a._position();
        })
        .on("click", function (d) {
          var e = a.s.d;
          e = d.target.nodeName.toLowerCase();
          var n = "span" === e ? d.target.parentNode : d.target;
          ...
          if ("select" !== e)
            if (
              ...
              var m = f(n);
              d = m.parent();
              if (d.hasClass("disabled") && !d.hasClass("range")) m.blur();
              else if (d.hasClass(b + "-iconLeft"))
                a.s.display.setUTCMonth(a.s.display.getUTCMonth() - 1),
                  a._setTitle(),
                  a._setCalander(),
                  a.dom.input.focus();
              else if (d.hasClass(b + "-iconRight"))
                ...
                if (m.parents("." + b + "-time").length) {
                  ...
                  e = a._needValue();
                  if ("minutes" === m) {
                    if (d.hasClass("disabled") && d.hasClass("range")) {
                      a.s.minutesRange = n;
                      a._setTime();
                      return;
                    }
                  ...
                  if ("am" === n)
                    if (12 <= e.getUTCHours()) n = e.getUTCHours() - 12;
                    else return;
                  else if ("pm" === n)
                    if (12 > e.getUTCHours()) n = e.getUTCHours() + 12;
                    else return;
                  ...
                  (e = a._needValue()),
                    e.setUTCDate(1),
                    e.setUTCFullYear(m.data("year")),
                    e.setUTCMonth(m.data("month")),
                    e.setUTCDate(m.data("day")),
                    a._writeOutput(!0),
                    a.s.parts.time
                      ? a._setCalander()
                      : setTimeout(function () {
    ...
    _compareDates: function (a, b) {
      return l && l == h.luxon
        ? l.DateTime.fromJSDate(a).toISODate() ===
            l.DateTime.fromJSDate(b).toISODate()
    ...
    _correctMonth: function (a, b) {
      var c = this._daysInMonth(a.getUTCFullYear(), b),
        g = a.getUTCDate() > c;
      a.setUTCMonth(b);
      g && (a.setUTCDate(c), a.setUTCMonth(b));
    },
    ...
    _hide: function (a) {
      if (a || "hidden" !== this.dom.input.attr("type"))
        (a = this.s.namespace),
          ...
          f(h).off("." + a),
          f(x).off("keydown." + a),
          f("div.dataTables_scrollBody").off("scroll." + a),
          f("div.DTE_Body_Content").off("scroll." + a),
          f("body").off("click." + a);
    },
    ...
    _htmlMonth: function (a, b) {
      var c = this._dateToUtc(new Date()),
        g = this._daysInMonth(a, b),
        d = new Date(Date.UTC(a, b, 1)).getUTCDay(),
        e = [],
        n = [];
      0 < this.c.firstDay && ((d -= this.c.firstDay), 0 > d && (d += 7));
      for (var m = g + d, q = m; 7 < q; ) q -= 7;
      m += 7 - q;
      var t = this.c.minDate;
      q = this.c.maxDate;
      t && (t.setUTCHours(0), t.setUTCMinutes(0), t.setSeconds(0));
      q && (q.setUTCHours(23), q.setUTCMinutes(59), q.setSeconds(59));
      for (var k = 0, p = 0; k < m; k++) {
        var u = new Date(Date.UTC(a, b, 1 + (k - d))),
          z = this.s.d ? this._compareDates(u, this.s.d) : !1,
          r = this._compareDates(u, c),
          B = k < d || k >= g + d,
          y = (t && u < t) || (q && u > q),
          w = this.c.disableDays;
        Array.isArray(w) && -1 !== f.inArray(u.getUTCDay(), w)
          ? (y = !0)
          : "function" === typeof w && !0 === w(u) && (y = !0);
        n.push(
          this._htmlDay({
            day: 1 + (k - d),
            month: b,
        ...
        7 === ++p &&
          (this.c.showWeekNumber &&
            n.unshift(this._htmlWeekOfYear(k - d, b, a)),
          e.push("<tr>" + n.join("") + "</tr>"),
          (n = []),
          (p = 0));
      }
      ...
      t &&
        ((t = t >= new Date(Date.UTC(a, b, 1, 0, 0, 0))),
        this.dom.title
          .find("div." + c + "-iconLeft")
          .css("display", t ? "none" : "block"));
      q &&
        ((a = q < new Date(Date.UTC(a, b + 1, 1, 0, 0, 0))),
        this.dom.title
    ...
    _htmlMonthHead: function () {
      ...
      for (var d = 0; 7 > d; d++) a.push("<th>" + g(d) + "</th>");
      return a.join("");
    },
    ...
    _options: function (a, b, c) {
      ...
      for (var g = 0, d = b.length; g < d; g++)
        a.append('<option value="' + b[g] + '">' + c[g] + "</option>");
    },
    ...
    _optionsTime: function (a, b, c, g, d) {
      var e = this.c.classPrefix,
        n = this.dom.container.find("div." + e + "-" + a),
        m =
          12 === b
            ? function (r) {
                return r;
      ...
      if (n.length) {
        var k = "";
        var p = 10;
        var u = function (r, B, y) {
          12 === b &&
            "number" === typeof r &&
            (12 <= c && (r += 12), 12 == r ? (r = 0) : 24 == r && (r = 12));
          var w =
            c === r || ("am" === r && 12 > c) || ("pm" === r && 12 <= c)
              ? "selected"
              : "";
          g && -1 === f.inArray(r, g) && (w += " disabled");
          y && (w += " " + y);
          return (
            '<td class="selectable ' +
            w +
        ...
        if (12 === b) {
          k += "<tr>";
          for (d = 1; 6 >= d; d++) k += u(d, m(d));
          k += u("am", t.amPm[0]);
          k += "</tr><tr>";
          for (d = 7; 12 >= d; d++) k += u(d, m(d));
          k += u("pm", t.amPm[1]);
          k += "</tr>";
          p = 7;
        } else {
          if (24 === b) {
            ...
            for (p = 0; 4 > p; p++) {
              k += "<tr>";
              for (d = 0; 6 > d; d++) (k += u(z, m(z))), z++;
              k += "</tr>";
            }
          } else {
            k += "<tr>";
            for (p = 0; 60 > p; p += 10) k += u(p, m(p), "range");
            d = null !== d ? d : 10 * Math.floor(c / 10);
            k =
              k +
              '</tr></tbody></thead><table class="' +
              (q + " " + q + '-nospace"><tbody><tr>');
            for (p = d + 1; p < d + 10; p++) k += u(p, m(p));
            k += "</tr>";
          }
          p = 6;
        }
    ...
    _position: function () {
      ...
      if (b.hasClass("inline")) b.insertAfter(this.dom.input);
        ...
        this.s.parts.date && this.s.parts.time && 550 < f(h).width()
        ...
        var g = b.outerHeight(),
          d = b.outerWidth(),
          e = f(h).scrollTop();
        a.top + c + g - e > f(h).height() &&
          ((c = a.top - g), b.css("top", 0 > c ? 0 : c));
        d + a.left > f(h).width() &&
          ((a = f(h).width() - d),
          "input" === this.c.attachTo &&
            (a -= f(b).offsetParent().offset().left),
          b.css("left", 0 > a ? 0 : a));
      }
    },
    _range: function (a, b, c) {
      var g = [];
      for (c || (c = 1); a <= b; a += c) g.push(a);
      return g;
    },
    ...
    _setTime: function () {
      var a = this,
        b = this.s.d,
        c = null;
      l && l == h.luxon && (c = l.DateTime.fromJSDate(b));
      var g = null != c ? c.hour : b ? b.getUTCHours() : 0,
        d = function (e) {
          return a.c[e + "Available"]
            ? a.c[e + "Available"]
            : a._range(0, 59, a.c[e + "Increment"]);
        };
      this._optionsTime(
        "hours",
    ...
    _show: function () {
      var a = this,
        b = this.s.namespace;
      this._position();
      f(h).on("scroll." + b + " resize." + b, function () {
        a._position();
      });
      f("div.DTE_Body_Content").on("scroll." + b, function () {
        a._position();
      });
      f("div.dataTables_scrollBody").on("scroll." + b, function () {
        a._position();
      });
      var c = this.dom.input[0].offsetParent;
      if (c !== x.body)
        f(c).on("scroll." + b, function () {
          a._position();
        });
      f(x).on("keydown." + b, function (g) {
        (9 !== g.keyCode && 27 !== g.keyCode && 13 !== g.keyCode) || a._hide();
      });
      setTimeout(function () {
        f("body").on("click." + b, function (g) {
          f(g.target).parents().filter(a.dom.container).length ||
            g.target === a.dom.input[0] ||
            a._hide();
        });
      }, 10);
    },
    _writeOutput: function (a) {
      ...
      b &&
        (c =
          l && l == h.luxon
            ? l.DateTime.fromJSDate(this.s.d).toFormat(this.c.format)
            : l
            ? l.utc(b, A, this.c.locale, this.c.strict).format(this.c.format)
            : b.getUTCFullYear() +
              "-" +
  ...
  v.version = "1.1.0";
  h.DateTime || (h.DateTime = v);
  f.fn.dtDateTime = function (a) {
    return this.each(function () {
      new v(this, a);
    });
  };
  f.fn.dataTable &&
    ((f.fn.dataTable.DateTime = v),
    (f.fn.DataTable.DateTime = v),
    f.fn.dataTable.Editor && (f.fn.dataTable.Editor.DateTime = v));
  return v;
});
