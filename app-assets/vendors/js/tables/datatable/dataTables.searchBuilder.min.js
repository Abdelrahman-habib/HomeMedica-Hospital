...
$jscomp.polyfillUnisolated = function (k, m, l, h) {
  ...
  m != h &&
    null != m &&
    $jscomp.defineProperty(l, k, { configurable: !0, writable: !0, value: m });
};
  ...
  function (k) {
    return k
      ...
      : function (m, l) {
          return (
            -1 !==
            $jscomp.checkStringArgs(this, m, "includes").indexOf(m, l || 0)
          );
        };
  },
  "es6",
  ...
  var h,
    ...
    r = (function () {
      function c(a, b, d, e, f) {
        ...
        this.c = h.extend(
          ...
          {},
          c.defaults,
          h.fn.dataTable.ext.searchBuilder,
          b
        );
        b = this.c.i18n;
        this.s = {
        ...
        this.dom = {
          ...
          delete: h("<button/>")
            ...
            .attr(
              "title",
              this.s.dt.i18n("searchBuilder.deleteTitle", b.deleteTitle)
            )
            .attr("type", "button"),
          left: h("<button/>")
            ...
            .attr(
              "title",
              this.s.dt.i18n("searchBuilder.leftTitle", b.leftTitle)
            )
            .attr("type", "button"),
          right: h("<button/>")
            ...
            .attr(
              "title",
              this.s.dt.i18n("searchBuilder.rightTitle", b.rightTitle)
            )
            .attr("type", "button"),
          value: [
            h("<select disabled/>")
          ...
          ).html(this.s.dt.i18n("searchBuilder.value", b.value)),
        };
        if (this.c.greyscale)
          for (
      ...
      c.prototype.updateArrows = function (a, b) {
        ...
        for (var d = 1; d < this.dom.value.length; d++)
          this.dom.container.append(this.dom.value[d]),
            this.dom.value[d].trigger("dtsb-inserted");
      ...
      c.prototype.search = function (a, b) {
        ...
        if (void 0 !== this.s.condition && void 0 !== d) {
          ...
          if ("array" === this.s.type)
            for (
              Array.isArray(e) || (e = [e]), e.sort(), b = 0, a = e;
              b < a.length;
              b++
            ) {
              var f = a[b];
      ...
      c.prototype.getDetails = function (a) {
        ...
        if (
          ...
          if (this.s.type.includes("date") || this.s.type.includes("time"))
            for (a = 0; a < this.s.value.length; a++)
              null ===
                this.s.value[a].match(
                  /^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g
                ) && (this.s.value[a] = "");
          else if (this.s.type.includes("moment"))
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] &&
                0 < this.s.value[a].length &&
                (this.s.value[a] = t(
                  this.s.value[a],
                  this.s.dateFormat
                ).toISOString());
            ...
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] &&
                0 < this.s.value[a].length &&
                (this.s.value[a] = v.DateTime.fromFormat(
                  this.s.value[a],
                  this.s.dateFormat
                ).toISO());
      ...
      c.prototype.rebuild = function (a) {
        ...
        if (void 0 !== a.data) {
          ...
          this.dom.data.children("option").each(function () {
            !b &&
            (h(this).text() === a.data ||
              (a.origData && h(this).prop("origData") === a.origData))
              ? (h(this).prop("selected", !0),
                f.removeClass(e),
                (b = !0),
                (d = h(this).val()))
        ...
        if (b) {
          ...
          if (void 0 !== this.s.condition) {
            ...
            for (q = 0; q < n.length; q++)
              (u = h(n[q])),
                u.val() !== this.s.condition && u.removeProp("selected");
      ...
      c.prototype.setListeners = function () {
        ...
        this.dom.condition.unbind("change").on("change.dtsb", function () {
          ...
          for (
            var b = a.dom.condition.children("option." + a.classes.option),
              d = 0;
            d < b.length;
            d++
          ) {
            ...
            if (e.val() === a.dom.condition.val()) {
              ...
              e = e.val();
              for (
                var f = 0, g = Object.keys(a.s.conditions);
                f < g.length;
                f++
              )
                if (g[f] === e) {
      ...
      c.prototype._populateCondition = function () {
        ...
        if (0 === b) {
          ...
          if (void 0 !== d)
            if (
              ((d = d[b]),
              void 0 !== d.searchBuilderType && null !== d.searchBuilderType)
            )
              this.s.type = d.searchBuilderType;
            else if (void 0 === this.s.type || null === this.s.type)
              this.s.type = d.sType;
      ...
      c.prototype._populateData = function () {
        ...
        if (0 === this.s.dataPoints.length)
          this.s.dt.columns().every(function (g) {
            if (
              !0 === a.c.columns ||
              a.s.dt.columns(a.c.columns).indexes().toArray().includes(g)
            ) {
              ...
              n ||
                ...
                (g = {
                  index: g,
                  origData: n.data,
                  text: (void 0 === n.searchBuilderTitle
                    ? n.sTitle
          ...
          for (
            var b = function (g) {
                d.s.dt.columns().every(function (q) {
                  ...
                  (void 0 === u.searchBuilderTitle
                    ? u.sTitle
                    : u.searchBuilderTitle
                  ).replace(/(<([^>]+)>)/gi, "") === g.text &&
                    ((g.index = q), (g.origData = u.data));
                });
                var n = h("<option>", {
                  text: g.text.replace(/(<([^>]+)>)/gi, ""),
                  value: g.index,
                })
      ...
      c.prototype._populateValue = function (a) {
        ...
        void 0 !== a &&
          this.s.dt.columns().every(function (n) {
            b.s.dt.settings()[0].aoColumns[n].sTitle === a.data &&
              (b.s.dataIdx = n);
          });
        this.dom.value = [].concat(
        ...
        for (f = 1; f < this.dom.value.length; f++)
          this.dom.value[f]
            .insertAfter(this.dom.value[f - 1])
            .trigger("dtsb-inserted");
        ...
        for (var u = [], D = [], H = 0; H < g.length; H++) {
          var z = g[H],
            A = n.oApi._fnGetCellData(
              ...
              z,
              f,
              "string" === typeof a.c.orthogonal
                ? a.c.orthogonal
                : a.c.orthogonal.search
            );
      ...
      c.initInput = function (a, b, d) {
        ...
        e = h("<input/>")
          ...
          .on(
            ...
            a._throttle(
              function (f) {
                return b(a, this, f.keyCode || f.which);
              },
              null === e ? 100 : e
            )
          );
      ...
      c.init2Input = function (a, b, d) {
        ...
        e = [
          ...
          h("<span>")
            ...
            .html(
              a.s.dt.i18n("searchBuilder.valueJoiner", a.c.i18n.valueJoiner)
            ),
          h("<input/>")
            .addClass(c.classes.value)
            .addClass(c.classes.input)
        ...
        a.c.greyscale &&
          (e[0].addClass(c.classes.greyscale),
          e[2].addClass(c.classes.greyscale));
      ...
      c.initDate = function (a, b, d) {
        ...
        var e = a.s.dt.settings()[0].searchDelay,
          f = h("<input/>")
            ...
            .on("input.dtsb keypress.dtsb", function (g) {
              a._throttle(
                function () {
                  return b(a, this, g.keyCode || g.which);
                },
                null === e ? 100 : e
              );
            });
      ...
      c.init2Date = function (a, b, d) {
        ...
        var f = a.s.dt.settings()[0].searchDelay,
          g = [
            h("<input/>")
              ...
              .on("input.dtsb keypress.dtsb", function (n) {
                a.s.dt.settings()[0].oApi._fnThrottle(
                  function () {
                    return b(a, this, n.keyCode || n.which);
                  },
                  null === f ? 0 : f
                );
              }),
        ...
        a.c.greyscale &&
          (g[0].addClass(c.classes.greyscale),
          g[2].addClass(c.classes.greyscale));
        null !== d && 0 < d.length && (g[0].val(d[0]), g[2].val(d[1]));
        a.s.dt.one("draw.dtsb", function () {
          a.s.topGroup.trigger("dtsb-redrawLogic");
        });
        return g;
      ...
      c.isInputValidSelect = function (a) {
        for (var b = !0, d = 0; d < a.length; d++) {
          ...
          e.children("option:selected").length ===
            e.children("option").length -
              e.children("option." + c.classes.notItalic).length &&
      ...
      c.updateListener = function (a, b, d) {
        ...
        if (a.s.filled) {
          ...
          g = f = null;
          for (e = 0; e < a.dom.value.length; e++)
            b === a.dom.value[e][0] &&
              ((f = e), void 0 !== b.selectionStart && (g = b.selectionStart));
          ((a.c.enterSearch ||
            (void 0 !== a.s.dt.settings()[0].oInit.search &&
              a.s.dt.settings()[0].oInit.search["return"])) &&
            13 !== d) ||
            a.s.dt.draw();
          null !== f &&
            (a.dom.value[f].removeClass(a.classes.italic),
            a.dom.value[f].focus(),
            null !== g && a.dom.value[f][0].setSelectionRange(g, g));
        } else
          ((a.c.enterSearch ||
            (void 0 !== a.s.dt.settings()[0].oInit.search &&
              a.s.dt.settings()[0].oInit.search["return"])) &&
      ...
      c.momentDateConditions = {
        ...
        "<": {
          ...
          search: function (a, b, d) {
            return (
              t(a, d.s.dateFormat).valueOf() < t(b[0], d.s.dateFormat).valueOf()
            );
          },
        },
        ">": {
    ...
    G = (function () {
      ...
      c.prototype.getDetails = function (a) {
        ...
        for (
          var b = { criteria: [], logic: this.s.logic },
            d = 0,
            e = this.s.criteria;
          d < e.length;
          d++
          ...
          for (var a = 0; a < this.s.criteria.length; a++) {
            ...
            b instanceof r
              ? ((this.s.criteria[a].index = a),
                ...
                this.s.criteria[a].criteria.dom.container.insertBefore(
                  this.dom.add
                ),
                this._setCriteriaListeners(b),
                (this.s.criteria[a].criteria.s.preventRedraw =
                  this.s.preventRedraw),
                this.s.criteria[a].criteria.rebuild(
                  this.s.criteria[a].criteria.getDetails()
                ),
                (this.s.criteria[a].criteria.s.preventRedraw = !1))
              ...
              ? ((this.s.criteria[a].index = a),
                ...
                (b.s.preventRedraw = this.s.preventRedraw),
                b.redrawContents(),
                (b.s.preventRedraw = !1),
      ...
      c.prototype.setListeners = function () {
        ...
        for (var b = 0, d = this.s.criteria; b < d.length; b++)
          d[b].criteria.setListeners();
        this._setClearListener();
        this._setLogicListener();
      };
      c.prototype.addCriteria = function (a, b) {
        ...
        for (var f = 0; f < this.s.criteria.length; f++)
          0 === f && this.s.criteria[f].criteria.s.index > e.s.index
            ? (e
                .getNode()
                .insertBefore(this.s.criteria[f].criteria.dom.container),
              (a = !0))
            : f < this.s.criteria.length - 1 &&
              ...
              (e
                .getNode()
                .insertAfter(this.s.criteria[f].criteria.dom.container),
              (a = !0));
        ...
        for (a = this.s.criteria; d < a.length; d++)
          (f = a[d]),
            f.criteria instanceof r &&
              f.criteria.updateArrows(1 < this.s.criteria.length, b);
      ...
      c.prototype._addPrevCriteria = function (a) {
        ...
        d.s.preventRedraw = this.s.preventRedraw;
        d.rebuild(a);
        d.s.preventRedraw = !1;
        this.s.criteria[b].criteria = d;
      ...
      c.prototype._andSearch = function (a, b) {
        ...
        for (var d = 0, e = this.s.criteria; d < e.length; d++) {
          ...
          if (
            !(
              (f.criteria instanceof r && !f.criteria.s.filled) ||
              f.criteria.search(a, b)
            )
          )
            return !1;
        }
      ...
      c.prototype._removeCriteria = function (a, b) {
        ...
        if (1 >= this.s.criteria.length && this.s.isChild) this.destroy();
          ...
          for (e = 0; e < this.s.criteria.length; e++)
            (this.s.criteria[e].index = e),
              (this.s.criteria[e].criteria.s.index = e);
        }
      };
      c.prototype._setCriteriaListeners = function (a) {
        ...
        a.dom["delete"].unbind("click").on("click.dtsb", function () {
          ...
          for (var d = 0, e = b.s.criteria; d < e.length; d++) {
            var f = e[d];
            f.criteria instanceof r &&
              f.criteria.updateArrows(1 < b.s.criteria.length);
          }
          a.destroy();
          b.s.dt.draw();
      ...
      c.prototype._setClearListener = function () {
        ...
        this.dom.clear.unbind("click").on("click.dtsb", function () {
          if (!a.s.isChild)
            return a.dom.container.trigger("dtsb-clearContents"), !1;
          a.destroy();
      ...
      c.prototype._setLogicListener = function () {
        ...
        this.dom.logic.unbind("click").on("click.dtsb", function () {
          a._toggleLogic();
          a.s.dt.draw();
          for (var b = 0, d = a.s.criteria; b < d.length; b++)
            d[b].criteria.setListeners();
        });
      };
    ...
    I = (function () {
          ...
          var d = function (n) {
              void 0 !== n.criteria
                ...
                : e.s.dt.columns().every(function (q) {
                    b.s.dt.settings()[0].aoColumns[q].sTitle === n.data &&
                      (n.dataIdx = q);
                  });
            },
            e = this,
      ...
      c.prototype._setUp = function (a) {
        var b = this;
        void 0 === a && (a = !0);
        x.fn.DataTable.Api.registerPlural(
          "columns().type()",
          "column().type()",
          function () {
        ...
        if (!C.DateTime) {
          ...
          if (void 0 === d || d.includes(void 0) || d.includes(null)) {
            d = [];
            for (
              var e = 0, f = this.s.dt.settings()[0].aoColumns;
              e < f.length;
              e++
            ) {
              var g = f[e];
              d.push(
                void 0 !== g.searchBuilderType ? g.searchBuilderType : g.sType
              );
            }
          }
      ...
      c.prototype._updateTitle = function (a) {
        this.dom.title.html(
          this.s.dt.i18n("searchBuilder.title", this.c.i18n.title, a)
        );
      };
      c.prototype._build = function () {
        ...
        this.s.dt.on("destroy.dtsb", function () {
          ...
          for (
            var e = x.fn.dataTable.ext.search.indexOf(a.s.search);
            -1 !== e;
      ...
      c.prototype._setRedrawListener = function () {
        ...
        this.s.topGroup.dom.container.on(
          ...
          function () {
            a._checkClear();
            a.s.topGroup.s.preventRedraw = !0;
            a.s.topGroup.redrawContents();
            a.s.topGroup.s.preventRedraw = !1;
            a.s.topGroup.setupLogic();
            a._setEmptyListener();
            var b = a.s.topGroup.count();
            a._updateTitle(b);
  ...
  (function (c) {
    ...
    c.fn.dataTable.ext.buttons.searchBuilder = {
      action: function (f, g, n, q) {
        ...
        f = q._searchBuilder.s.topGroup;
        void 0 !== f && f.dom.container.trigger("dtsb-redrawContents");
        0 === f.s.criteria.length &&
          c("." + c.fn.dataTable.Group.classes.add.replace(/ /g, ".")).click();
      },
      config: {},
      init: function (f, g, n) {
        ...
        f.button(g).text(
          n.text || f.i18n("searchBuilder.button", q.c.i18n.button, 0)
        );
        n._searchBuilder = q;
      },
      text: null,
