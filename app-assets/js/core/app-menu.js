(function (window, document, $) {
  ...
  let collapsedIcon = "bx bx-circle";
  let expandedIcon = "bx bx-disc";
  let collapsedIconAlt = "bx bx-menu ";
  let expandedIconAlt = "bx bx-x bx-rotate-45";
    ...
    expand: function () {
      if (this.expanded === false) {
        if ($body.data("menu") == "vertical-menu-modern") {
          $(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass(collapsedIconAlt)
            .addClass(expandedIconAlt);
        }
        this.transit(
          function () {
    ...
    collapse: function (defMenu) {
      if (this.collapsed === false) {
        if ($body.data("menu") == "vertical-menu-modern") {
          $(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass(expandedIconAlt)
            .addClass(collapsedIconAlt);
        }
        this.transit(
          function () {
